...
!repeat/i=1:45 (repeat/j=1:25 ( list/nohead/q/append/file=${MODEL}.space1.txt co ))
...
frame/file=eof1.ar5.dtred.annual.${MODEL}.gif
...
frame/file=eof2.ar5.dtred.annual.${MODEL}.gif
